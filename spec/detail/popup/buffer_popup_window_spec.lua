...
describe("detail.popup.buffer_popup_window", function()
  ...
  describe("[_make_view/_adjust_view]", function()
    it("_adjust_view", function()
      local actual11, actual12 = buffer_popup_window._adjust_view(20, 30, 100, 30)
      print(string.format("_adjust_view-1:%s,%s\n", vim.inspect(actual11), vim.inspect(actual12)))
      local actual21, actual22 = buffer_popup_window._adjust_view(1, 10, 100, 30)
      print(string.format("_adjust_view-2:%s,%s\n", vim.inspect(actual21), vim.inspect(actual22)))
      local actual31, actual32 = buffer_popup_window._adjust_view(90, 100, 100, 30)
      print(string.format("_adjust_view-3:%s,%s\n", vim.inspect(actual31), vim.inspect(actual32)))
      local actual41, actual42 = buffer_popup_window._adjust_view(20, 50, 100, 30)
      print(string.format("_adjust_view-4:%s,%s\n", vim.inspect(actual41), vim.inspect(actual42)))
    end)
    it("_make_view_by_top", function()
      local actual1 = buffer_popup_window._make_view_by_top(10, 50)
      print(string.format("_make_view_by_top-1:%s\n", vim.inspect(actual1)))
      local actual2 = buffer_popup_window._make_view_by_top(30, 30)
      print(string.format("_make_view_by_top-2:%s\n", vim.inspect(actual2)))
      local actual3 = buffer_popup_window._make_view_by_top(30, 29)
      print(string.format("_make_view_by_top-3:%s\n", vim.inspect(actual3)))
      local actual4 = buffer_popup_window._make_view_by_top(40, 41)
