...
describe("detail.bat_helpers", function()
  ...
  describe("[_create_dir_if_not_exist]", function()
    it("test", function()
      ...
      local actual1 = bat_helpers._create_dir_if_not_exist(tmp)
      assert_true(actual1)
      local actual2 = bat_helpers._create_dir_if_not_exist(tmp)
  ...
  describe("[get_theme_dir]", function()
    it("test", function()
      if consts.HAS_BAT then
        local actual = bat_helpers.get_theme_dir()
  ...
  describe("[async_get_theme_dir]", function()
    it("test", function()
      if consts.HAS_BAT then
        bat_helpers.async_get_theme_dir(function(theme_dir)
  ...
  describe("[_upper_first]", function()
    it("test", function()
      ...
      local actual = bat_helpers._upper_first(inputs)
  ...
  describe("[_normalize_by]", function()
    ...
    it("solarized8_high", function()
      assert_eq(bat_helpers._normalize_by("solarized8_high", "-"), "Solarized8_high")
      assert_eq(bat_helpers._normalize_by("solarized8_high", "_"), "Solarized8High")
    end)
  ...
  describe("[get_theme_name]", function()
    it("test", function()
      ...
      for i, v in ipairs(inputs) do
        local actual = bat_helpers.get_theme_name(v)
  ...
  describe("[get_theme_config_filename]", function()
    it("test", function()
      ...
      if consts.HAS_BAT then
        for i, v in ipairs(inputs) do
          local actual = bat_helpers.get_theme_config_filename(v) --[[@as string]]
