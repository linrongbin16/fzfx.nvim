...
> Actually all above features are built on an engine support fully dynamic runtime & pipeline control, it allows you to do almost anything you want, please see [Configuration](#configuration) and [wiki](https://github.com/linrongbin16/fzfx.nvim/wiki/Wiki-Home).
