...
- `fzfx.lib`: Low-level fundamental infrastructures, fzfx use the [commons](https://github.com/linrongbin16/commons.nvim) lua library for most of the common utilities, please also refer to [the commons.nvim's Documentation](https://linrongbin16.github.io/commons.nvim/).

  > The **commons** lua library was originally part of the **fzfx.lib** modules, since I found they're so common useful that I need them for most of my Neovim plugins.
