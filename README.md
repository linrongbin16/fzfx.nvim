...
- Neovim &ge; 0.9.
  > This plugin always keeps up with the latest stable version, while only support the last legacy version to reduce maintenance effort, i.e. at the time of writing this, 2024-06-11, the stable version is v0.10, nightly is v0.11, last legacy is v0.9.
