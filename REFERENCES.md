...
- `parse_find(line:string):{filename:string}`: parse the line generated by `fd`/`find` or other sources (buffers) follow the same style, remove the prepend icon if it's enabled. used by `FzfxFiles`, `FzfxBuffers`, `FzfxGFiles`.
