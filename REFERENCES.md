...
The ***parsers*** are low-level components that help previewers (include previewer labels), and actions understand the lines generated from providers, they're the bridge between providers and previewers/actions.
