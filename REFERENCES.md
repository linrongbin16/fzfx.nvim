...
The parsers are very important components that help preview (include previewer label), and (inter-)actions understand the lines generated from providers, they're the bridge between providers and previewers/actions.
