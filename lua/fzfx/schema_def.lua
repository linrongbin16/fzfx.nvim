...
--  * Plain provider: a plain command string to execute and generate the list.
...
--  * Builtin previewer (nvim buffer & window): a lua function to run and generate a nvim buffer (todo).
...
--- @alias BuiltinPreviewer fun(...:any):string
...
--
--- @alias CommandFeed "args"|"visual"|"cword"|"yank"
...
--- @field line_processor_type LineProcessorType?
