...
### [`buf_is_valid`](https://github.com/linrongbin16/fzfx.nvim/blob/6cde87c522460d4da2a9c657ce4615ce619cca45/lua/fzfx/lib/bufs.lua?plain=1#L5)

`function(bufnr:integer?):boolean`: Whether the buffer (`bufnr`) is a valid and visible buffer for user.
...
### [`CommandResult`](https://github.com/linrongbin16/fzfx.nvim/blob/6cde87c522460d4da2a9c657ce4615ce619cca45/lua/fzfx/lib/commands.lua?plain=1#L14)

`@class fzfx.CommandResult`: The executed results of a shell command, i.e. outputs, errors, exit code, etc.
...
### [`Command`](https://github.com/linrongbin16/fzfx.nvim/blob/6cde87c522460d4da2a9c657ce4615ce619cca45/lua/fzfx/lib/commands.lua?plain=1#L50)

`@class fzfx.Command`: The executable shell command.
...
### [`GitRootCommand`](https://github.com/linrongbin16/fzfx.nvim/blob/6cde87c522460d4da2a9c657ce4615ce619cca45/lua/fzfx/lib/commands.lua?plain=1#L98)

`@class fzfx.GitRootCommand`: Run git command to find out the git repository's root directory. This is super helpful to detect whether current working directory is in a git repository.
...
### [`GitBranchesCommand`](https://github.com/linrongbin16/fzfx.nvim/blob/6cde87c522460d4da2a9c657ce4615ce619cca45/lua/fzfx/lib/commands.lua?plain=1#L134)

`@class fzfx.GitBranchesCommand`: Run git command to find out it's local/remote branches.
...
### [`GitCurrentBranchCommand`](https://github.com/linrongbin16/fzfx.nvim/blob/6cde87c522460d4da2a9c657ce4615ce619cca45/lua/fzfx/lib/commands.lua?plain=1#L171)

`@class fzfx.GitCurrentBranchCommand`: Run git command to find out current branch name.
...
### [`GitRemotesCommand`](https://github.com/linrongbin16/fzfx.nvim/blob/6cde87c522460d4da2a9c657ce4615ce619cca45/lua/fzfx/lib/commands.lua?plain=1#L208)

`@class fzfx.GitRemotesCommand`: Run git command to find out the configured remotes.
...
### [`debug_enabled`](https://github.com/linrongbin16/fzfx.nvim/blob/6cde87c522460d4da2a9c657ce4615ce619cca45/lua/fzfx/lib/env.lua?plain=1#L4)

`function():boolean`

- [`icon_enabled`](https://github.com/linrongbin16/fzfx.nvim/blob/6cde87c522460d4da2a9c657ce4615ce619cca45/lua/fzfx/lib/env.lua?plain=1#L9)
...
### [`LogLevels`](https://github.com/linrongbin16/fzfx.nvim/blob/6cde87c522460d4da2a9c657ce4615ce619cca45/lua/fzfx/lib/log.lua?plain=1#L5)

`TRACE`, `DEBUG`, `INFO`, `WARN`, `ERROR`, `OFF`, they're compatible with the [`vim.log.levels`](https://neovim.io/doc/user/lua.html#log_levels), but in this plugin we don't use `TRACE` and `OFF`.

### [`echo`](https://github.com/linrongbin16/fzfx.nvim/blob/6cde87c522460d4da2a9c657ce4615ce619cca45/lua/fzfx/lib/log.lua?plain=1#L20)

`function(level:commons.LogLevels, msg:string):nil`: Print logs as Neovim's message. Note: This API doesn't require this plugin setup, thus you can use it even before this plugin setup.

### [`setup`](https://github.com/linrongbin16/fzfx.nvim/blob/6cde87c522460d4da2a9c657ce4615ce619cca45/lua/fzfx/lib/log.lua?plain=1#L56)

`function(opts:fzfx.Options?):nil`: Setup the logging system. Note: This API is been invoked automatically when this plugin setup.

The `opts` parameter is an optional lua table contains below fields:
...
`function(msg:string):nil`: Logs the message.

### [`throw`](https://github.com/linrongbin16/fzfx.nvim/blob/6cde87c522460d4da2a9c657ce4615ce619cca45/lua/fzfx/lib/log.lua?plain=1#L124)

`function(msg:string):nil`: Logs the message and throw an error to Neovim, equivalent to Neovim's `error` API.

### [`ensure`](https://github.com/linrongbin16/fzfx.nvim/blob/6cde87c522460d4da2a9c657ce4615ce619cca45/lua/fzfx/lib/log.lua?plain=1#L140)

`function(condition:boolean?,msg:string):nil`: Assert the `condition` is true. When it's `false`, logs the message and throw an error to Neovim, equivalent to Neovim's `assert` API.
