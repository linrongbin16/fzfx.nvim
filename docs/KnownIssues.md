...
But when there're whitespaces on the path, launching correct fzf command becomes quite difficult, since it will seriously affected escaping characters. Here're two typical cases:
