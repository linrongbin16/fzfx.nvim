...
describe("helpers", function()
  ...
  describe("[get_command_feed]", function()
    it("get normal args feed", function()
      local expect = "expect"
      local actual =
        fzf_helpers.get_command_feed({ args = expect }, CommandFeedEnum.ARGS)
      assert_eq(expect, actual)
    end)
    it("get visual select feed", function()
      local actual = fzf_helpers.get_command_feed({}, CommandFeedEnum.VISUAL)
      assert_eq(type(actual), "string")
    end)
    it("get cword feed", function()
      local actual = fzf_helpers.get_command_feed({}, CommandFeedEnum.CWORD)
      assert_eq(type(actual), "string")
    end)
  end)
