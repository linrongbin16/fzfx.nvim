...
describe("detail.popup", function()
  ...
  describe("[_shift_window_pos]", function()
    it("is in range of [0, 1]", function()
      assert_eq(12, popup._shift_window_pos(50, 30, 0.1))
      assert_eq(10, popup._shift_window_pos(50, 30, 0))
      assert_eq(0, popup._shift_window_pos(50, 25, -0.5))
      assert_eq(24, popup._shift_window_pos(50, 25, 0.5))
    end)
    it("is greater than 1", function()
      assert_eq(12, popup._shift_window_pos(50, 30, 2))
      assert_eq(10, popup._shift_window_pos(50, 30, 0))
      assert_eq(0, popup._shift_window_pos(50, 20, -15))
      assert_eq(30, popup._shift_window_pos(50, 20, 15))
    end)
  end)
