...
describe("lib.nvim", function()
  ...
  describe("[buf_is_valid]", function()
    it("valid", function()
      assert_false(libnvims.buf_is_valid())
      assert_false(libnvims.buf_is_valid(nil))
    end)
  end)
  describe("[get_win_option/set_win_option]", function()
    it("get spell", function()
      libnvims.set_win_option(0, "spell", true)
      local s = libnvims.get_win_option(0, "spell")
      print(string.format("spell get win option:%s\n", vim.inspect(s)))
      assert_eq(type(s), "boolean")
      assert_true(s)
    end)
    it("set spell", function()
      libnvims.set_win_option(0, "spell", false)
      local s = libnvims.get_win_option(0, "spell")
  ...
  describe("[WindowOptsContext]", function()
    it("save", function()
      local ctx = libnvims.WindowOptsContext:save()
